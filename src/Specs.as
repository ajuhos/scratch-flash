...
public class Specs {
	...
	public static const categories:Array = [
	 // id   category name	color
		...
		[92, "Looks (override)", 0x8a55d7],
		[94, "Pen (override)",	 0x0e9a6c]
	];
	...
	public static var commands:Array = [
		...
		["switch costume to %m.costume",		" ", 92, "setCostumeTo:",			"costume1"],
		...
		["set pen size to %n",					" ", 94, "setPenSizeTo:", 		1],
		["-"],
		...
		//["when I receive %s from network", 		"h", 5, "whenSocket",		""],
		["broadcast %m.broadcast",				" ", 5, "broadcast:",			""],
		//["broadcast %s on network with %s",		" ", 5, "broadcastSocket:with:",		""],
		...
		["-"],
		//["data from network",					"r", 7, "socketData"],
		//["-"],
		...
		//["set %s to %s",									" ", 9, SET_VAR],
		//["change %s by %n",									" ", 9, CHANGE_VAR],
		//["get %s",								    		"r", 9, READ_VAR],	
